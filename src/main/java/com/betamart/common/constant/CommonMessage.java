package com.betamart.common.constant;
...
public interface CommonMessage {
    ...
    public static final String AUTH_ERROR           = "Username not found and/or Password is invalid!";
    public static final String AUTH_INVALID_FORMAT  = "Invalid format input!";
